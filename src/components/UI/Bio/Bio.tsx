import { StyledBio } from "./Bio.style";
      ...
      <div className="bio__data">
        <div className="data__item">
          ...
          <p className="main__text">
            День рождения: <span>{dataUser}</span>
          </p>
        </div>
        <div className="data__item">
          <svg
        ...
        <div className="data__item">
          ...
          <p className="main__text">
            Статус: <span>{statusUser}</span>
          </p>
        </div>
      </div>
      <div className="bio__info">
        <p className="main__text education">Образование</p>
        <p className="secondary__text education">{pUser}</p>
        <p className="main__text activity">Деятельность</p>
        <p className="secondary__text activity">{activityUser}</p>
        <p className="main__text hobby">Хобби</p>
        <p className="secondary__text hobby">{hobbyUser}</p>
      </div>
