import { StyledProfileUser} from "./ProfileUser.style";
...
export const ProfileUser: React.FC<ProfileUserProps> = ({
    userImg,
    userAlt,
    userName,
    countFriends,
            ...
            <div className="user__description">
              ...
              <div className="user__info">
                <div className="parameter">
                  ...
                  <span className="value">{countFriends}</span>
                </div>
                <div className="parameter">
                  <span className="key">Подписчики</span>
                  <span className="value">{countSubscribers}</span>
                </div>
                <div className="parameter">
                  <span className="key">Подписки</span>
                  <span className="value">{countSubscriptions}</span>
                </div>
              </div>
            </div>
